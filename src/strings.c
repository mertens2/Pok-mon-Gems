...
const u8 gText_MainMenuMysteryGift[] = _("Reg.Mister.");
const u8 gText_MainMenuMysteryGift2[] = _("Reg.Mister.");
const u8 gText_MainMenuMysteryEvents[] = _("Ev.Mister.");
const u8 gText_WirelessNotConnected[] = _("El Wireless Adapter no está\n emulado correctamente.");
...
ALIGNED(4) const u8 gText_PickCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}{B_BUTTON}Cancelar");
...
const u8 gText_ShopQuit[] = _("No, gracias");
const u8 gText_InBagVar1[] = _("Tienes: {STR_VAR_1}");
...
const u8 gText_HereYouGoThankYou[] = _("¡Toma ya!\nMuchas gracias por elegirnos.");
const u8 gText_ThankYouIllSendItHome[] = _("¡Gracias!\nTe lo enviaré a tu PC.");
const u8 gText_ThanksIllSendItHome[] = _("¡Gracias!\nTe lo enviaré a tu PC.");
const u8 gText_YouDontHaveMoney[] = _("No te alcanza el dinero.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreRoomForThis[] = _("No tienes espacio para más objetos.{PAUSE_UNTIL_PRESS}");
const u8 gText_SpaceForVar1Full[] = _("No tienes espacio para más {STR_VAR_1}.{PAUSE_UNTIL_PRESS}");
const u8 gText_AnythingElseICanHelp[] = _("¿Con qué otra cosa te puedo\nayudar?");
const u8 gText_CanIHelpWithAnythingElse[] = _("¿Necesitas algo más?");
const u8 gText_ThrowInPremierBall[] = _("Te daré una Premier Ball, también.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NoEntry[] = _("Mejor no");
...
const u8 gText_BagFullCouldNotRemoveItem[] = _("The Mochila is full. The Pokémon's\nitem could not be removed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChoosePokemon[] = _("Elije un Pokémon.");
...
const u8 gText_ChoosePokemon2[] = _("Elije un Pokémon.");
...
const u8 gText_ChoosePokemonCancel[] = _("Elije un Pokémon o cancela.");
const u8 gText_ChoosePokemonConfirm[] = _("Elije un Pokémon y acepta.");
...
const u8 gText_Accuracy2[] = _("Precision");
...
const u8 gText_BattleMoves[] = _("Combate MOVES");
...
const u8 gText_MoveToBag[] = _("Poner en Mochila");
...
const u8 gText_BagIsFull[] = _("The Mochila is full.{PAUSE_UNTIL_PRESS}");
const u8 gText_MailToBagMessageErased[] = _("The MAIL was returned to the Mochila\nwith its message erased.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SingleBattle[] = _("Combate");
...
const u8 gText_BattleFrontier[] = _("Combate FRONTIER");
...
const u8 gText_MenuOptionExit[] = _("Eso es todo");
...
const u8 gText_Badge1[] = _("Medalla 1");
const u8 gText_Badge2[] = _("Medalla 2");
const u8 gText_Badge3[] = _("Medalla 3");
const u8 gText_Badge4[] = _("Medalla 4");
const u8 gText_Badge5[] = _("Medalla 5");
const u8 gText_Badge6[] = _("Medalla 6");
const u8 gText_Badge7[] = _("Medalla 7");
const u8 gText_Badge8[] = _("Medalla 8");
...
const u8 gText_BattlePts[] = _("Combate PTS");
const u8 gText_TowerInfo[] = _("TOWER INFO");
const u8 gText_BattleMon[] = _("Combate {PKMN}");
const u8 gText_BattleSalon[] = _("Combate SALON");
const u8 gText_MultiLink2[] = _("MULTI-LINK");
const u8 gText_BattleRules[] = _("Combate RULES");
...
const u8 gText_BattleBag2[] = _("Combate Mochila");
...
const u8 gText_BattlePokemon[] = _("Combate Pokémon");
const u8 gText_BattleTrainers[] = _("Combate TRAINERS");
...
const u8 gText_PlacedItemInBag[] = _("Placed item in the Mochila.");
const u8 gText_BagIsFull2[] = _("The Mochila is full.");
const u8 gText_PutItemInBag[] = _("Put this item in the Mochila?");
...
const u8 gPCText_Take[] = _("Dar");
const u8 gPCText_Give[] = _("Tomar");
...
const u8 gText_LinkBattles[] = _("LINK CombateS");
const u8 gText_LinkCableBattles[] = _("LINK CABLE CombateS");
...
const u8 gText_UnionTradesAndBattles[] = _("UNION TRADES & CombateS");
...
const u8 gText_BattlePtsWon[] = _("Combate POINTS WON");
const u8 gText_Var1DarkLightGreyBP[] = _("{STR_VAR_1}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}BP");
const u8 gText_BattleTower[] = _("Combate TOWER");
...
const u8 gText_BattleTower2[] = _("Combate TOWER");
const u8 gText_BattleDome[] = _("Combate DOME");
const u8 gText_BattlePalace[] = _("Combate PALACE");
const u8 gText_BattleFactory[] = _("Combate FACTORY");
const u8 gText_BattleArena[] = _("Combate ARENA");
const u8 gText_BattlePike[] = _("Combate PIKE");
const u8 gText_BattlePyramid[] = _("Combate PYRAMID");
...
const u8 gText_AlreadySavedFile_Unused[] = _("¿Sobreescribir datos?");
const u8 gText_SavingDontTurnOff_Unused[] = _("GUARDANDO…\nNO CIERRES EL EMULADOR.");
const u8 gText_PlayerSavedGame_Unused[] = _("{SPECIAL_F7 0x00} guardo la partida.");
...
const u8 gText_CheckFrontierMap[] = _("Check Combate FRONTIER MAP.");
...
const u8 gText_BattleTower3[] = _("Combate TOWER");
const u8 gText_BattleDome2[] = _("Combate DOME");
const u8 gText_BattlePalace2[] = _("Combate PALACE");
const u8 gText_BattleArena2[] = _("Combate ARENA");
const u8 gText_BattleFactory2[] = _("Combate FACTORY");
const u8 gText_BattlePike2[] = _("Combate PIKE");
const u8 gText_BattlePyramid2[] = _("Combate PYRAMID");
...
const u8 gText_BattleScene[] = _("Escena");
...
const u8 gText_MenuRetire[] = _("Rendirse");
...
const u8 gText_PokedexDiploma[] = _("Jugador: {CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR DARK_GREY}{SHADOW LIGHT_GREY}\n\nThis document certifies\nthat you have successfully\ncompleted your\n{STR_VAR_1} PokéDex.\n\n{CLEAR_TO 0x42}{COLOR RED}{SHADOW LIGHT_RED}GAME FREAK");
...
const u8 gText_MaxHP[] = _("PS Maximos");
...
const u8 gText_BoxName[] = _("¿Nombre?");
...
ALIGNED(4) const u8 gText_PickOKCancel[] = _("{DPAD_UPDOWN}PICK {A_BUTTON}OK {B_BUTTON}Cancelar");
const u8 gText_PlayersBattleResults[] = _("{PLAYER}'s Combate RESULTS");
...
const u8 gText_MoveRelearnerBattleMoves[] = _("Combate MOVES");
...
const u8 gText_MoveRelearnerAccuracy[] = _("Precision/");
...
const u8 gText_StevenMatchCallDesc[] = _("Duro como la roca");
...
const u8 gText_ScottMatchCallDesc[] = _("ELUSIVE ESi");
...
const u8 gText_ThrowInPremierBalls[] = _("Te daré algunas Premier Ball, también.{PAUSE_UNTIL_PRESS}");
