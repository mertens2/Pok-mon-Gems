...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_HEADBUTT, MOVE_ROCK_POLISH, MOVE_SAND_TOMB, MOVE_ROCK_TOMB},
    .abilityNums = 0,
    },
    {
    .iv = 130,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAIL_WHIP, MOVE_BITE, MOVE_ROCK_THROW, MOVE_ROCK_TOMB},
    .abilityNums = 0,
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_CLAW, MOVE_THUNDER_PUNCH, MOVE_SEISMIC_TOSS, MOVE_BULK_UP},
    .abilityNums = 0,
    },
    {
    .iv = 130,
    ...
    .moves = {MOVE_BULK_UP, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_MACH_PUNCH},
    .abilityNums = 0,
    },
    {
    .iv = 200,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_FLASH, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE},
    .abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_AGILITY, MOVE_QUICK_ATTACK, MOVE_ELECTRO_BALL},
    .abilityNums = 0,
    },
    {
    .iv = 220,
    ...
    .moves = {MOVE_CONFUSE_RAY, MOVE_SHOCK_WAVE, MOVE_FLASH_CANNON, MOVE_MAGNET_RISE},
    .abilityNums = 0,
    },
    {
    .iv = 250,
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_EXTREME_SPEED, MOVE_THUNDER_FANG, MOVE_SHOCK_WAVE, MOVE_HOWL},
    .abilityNums = 0,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_CLOSE_COMBAT, MOVE_BULK_UP, MOVE_SUNNY_DAY},
    .abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_SUPERPOWER, MOVE_BULK_UP, MOVE_SUNNY_DAY},
    .abilityNums = 0,
    },
    {
    .iv = 250,
    ...
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_DOUBLE_EDGE, MOVE_SUNNY_DAY, MOVE_ATTRACT},
    .abilityNums = 0,
    },
    {
    .iv = 250,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_FEATHER_DANCE, MOVE_AERIAL_ACE, MOVE_FACADE, MOVE_ROOST},
    .abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_EXTREME_SPEED, MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT},
    .abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_HEADBUTT},
    .abilityNums = 0,
    },
    {
    .iv = 200,
    ...
    .moves = {MOVE_ROLLOUT, MOVE_DEFENSE_CURL, MOVE_FACADE, MOVE_ROOST},
    .abilityNums = 0,
    },
    {
    .iv = 250,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SKILL_SWAP, MOVE_YAWN, MOVE_FACADE, MOVE_FAINT_ATTACK},
    .abilityNums = 0,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_ANCIENT_POWER, MOVE_AERIAL_ACE, MOVE_SURF},
    .abilityNums = 2,
    },
    {
    .iv = 255,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AquaGruntM[] = {
    {
    .iv = 22,
    .lvl = 15,
    .species = SPECIES_CORPHISH,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AquaGruntF1[] = {
    {
    .iv = 16,
    .lvl = 14,
    .species = SPECIES_CARVANHA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_AquaGruntF2[] = {
	{
    .iv = 16,
    .lvl = 16,
