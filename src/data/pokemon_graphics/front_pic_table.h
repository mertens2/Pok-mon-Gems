const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BURMY_SANDY, gMonFrontPic_BurmySandy),
    SPECIES_SPRITE(BURMY_TRASH, gMonFrontPic_BurmyTrash),
    SPECIES_SPRITE(WORMADAM, gMonFrontPic_WormadamPlant),
    SPECIES_SPRITE(WORMADAM_SANDY, gMonFrontPic_WormadamSandy),
    SPECIES_SPRITE(WORMADAM_TRASH, gMonFrontPic_WormadamTrash),
    ...
    SPECIES_SPRITE(MEOWSTIC_F, gMonFrontPic_MeowsticFemale),
    ...
    SPECIES_SPRITE(MEGA_VENUSAUR, gMonFrontPic_MegaVenusaur),
    SPECIES_SPRITE(MEGA_CHARIZARD_X, gMonFrontPic_MegaCharizardX),
    SPECIES_SPRITE(MEGA_CHARIZARD_Y, gMonFrontPic_MegaCharizardY),
    SPECIES_SPRITE(MEGA_BLASTOISE, gMonFrontPic_MegaBlastoise),
    SPECIES_SPRITE(MEGA_BEEDRILL, gMonFrontPic_MegaBeedrill),
    SPECIES_SPRITE(MEGA_PIDGEOT, gMonFrontPic_MegaPidgeot),
    SPECIES_SPRITE(MEGA_ALAKAZAM, gMonFrontPic_MegaAlakazam),
    SPECIES_SPRITE(MEGA_SLOWBRO, gMonFrontPic_MegaSlowbro),
    SPECIES_SPRITE(MEGA_GENGAR, gMonFrontPic_MegaGengar),
    SPECIES_SPRITE(MEGA_KANGASKHAN, gMonFrontPic_MegaKangaskhan),
    SPECIES_SPRITE(MEGA_PINSIR, gMonFrontPic_MegaPinsir),
    SPECIES_SPRITE(MEGA_GYARADOS, gMonFrontPic_MegaGyarados),
    SPECIES_SPRITE(MEGA_AERODACTYL, gMonFrontPic_MegaAerodactyl),
    SPECIES_SPRITE(MEGA_MEWTWO_X, gMonFrontPic_MegaMewtwoX),
    SPECIES_SPRITE(MEGA_MEWTWO_Y, gMonFrontPic_MegaMewtwoY),
    SPECIES_SPRITE(MEGA_AMPHAROS, gMonFrontPic_MegaAmpharos),
    SPECIES_SPRITE(MEGA_STEELIX, gMonFrontPic_MegaSteelix),
    SPECIES_SPRITE(MEGA_SCIZOR, gMonFrontPic_MegaScizor),
    SPECIES_SPRITE(MEGA_HERACROSS, gMonFrontPic_MegaHeracross),
    SPECIES_SPRITE(MEGA_HOUNDOOM, gMonFrontPic_MegaHoundoom),
    SPECIES_SPRITE(MEGA_TYRANITAR, gMonFrontPic_MegaTyranitar),
    SPECIES_SPRITE(MEGA_SCEPTILE, gMonFrontPic_MegaSceptile),
    SPECIES_SPRITE(MEGA_BLAZIKEN, gMonFrontPic_MegaBlaziken),
    SPECIES_SPRITE(MEGA_SWAMPERT, gMonFrontPic_MegaSwampert),
    SPECIES_SPRITE(MEGA_GARDEVOIR, gMonFrontPic_MegaGardevoir),
    SPECIES_SPRITE(MEGA_SABLEYE, gMonFrontPic_MegaSableye),
    SPECIES_SPRITE(MEGA_MAWILE, gMonFrontPic_MegaMawile),
    SPECIES_SPRITE(MEGA_AGGRON, gMonFrontPic_MegaAggron),
    SPECIES_SPRITE(MEGA_MEDICHAM, gMonFrontPic_MegaMedicham),
    SPECIES_SPRITE(MEGA_MANECTRIC, gMonFrontPic_MegaManectric),
    ...
    SPECIES_SPRITE(MEGA_GLALIE, gMonFrontPic_MegaGlalie),
    SPECIES_SPRITE(MEGA_SALAMENCE, gMonFrontPic_MegaSalamence),
    SPECIES_SPRITE(MEGA_METAGROSS, gMonFrontPic_MegaMetagross),
    SPECIES_SPRITE(MEGA_LATIAS, gMonFrontPic_MegaLatias),
    SPECIES_SPRITE(MEGA_LATIOS, gMonFrontPic_MegaLatios),
    SPECIES_SPRITE(PRIMAL_KYOGRE, gMonFrontPic_PrimalKyogre),
    SPECIES_SPRITE(PRIMAL_GROUDON, gMonFrontPic_PrimalGroudon),
    SPECIES_SPRITE(MEGA_RAYQUAZA, gMonFrontPic_MegaRayquaza),
    SPECIES_SPRITE(MEGA_LOPUNNY, gMonFrontPic_MegaLopunny),
    SPECIES_SPRITE(MEGA_GARCHOMP, gMonFrontPic_MegaGarchomp),
    SPECIES_SPRITE(MEGA_LUCARIO, gMonFrontPic_MegaLucario),
    SPECIES_SPRITE(MEGA_ABOMASNOW, gMonFrontPic_MegaAbomasnow),
    SPECIES_SPRITE(MEGA_GALLADE, gMonFrontPic_MegaGallade),
    SPECIES_SPRITE(MEGA_AUDINO, gMonFrontPic_MegaAudino),
    SPECIES_SPRITE(MEGA_DIANCIE, gMonFrontPic_MegaDiancie),
    ...
    SPECIES_SPRITE(MINIOR_CORE, gMonFrontPic_MiniorCore),
