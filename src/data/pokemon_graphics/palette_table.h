const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(ALOLAN_RAICHU, gMonPalette_AlolanRaichu),
    SPECIES_PAL(ALOLAN_SANDSHREW, gMonPalette_AlolanSandshrew),
    SPECIES_PAL(ALOLAN_SANDSLASH, gMonPalette_AlolanSandslash),
    SPECIES_PAL(ALOLAN_VULPIX, gMonPalette_AlolanVulpix),
    SPECIES_PAL(ALOLAN_NINETALES, gMonPalette_AlolanNinetales),
    SPECIES_PAL(ALOLAN_DIGLETT, gMonPalette_AlolanDiglett),
    SPECIES_PAL(ALOLAN_DUGTRIO, gMonPalette_AlolanDugtrio),
    SPECIES_PAL(ALOLAN_MEOWTH, gMonPalette_AlolanMeowth),
    SPECIES_PAL(ALOLAN_PERSIAN, gMonPalette_AlolanPersian),
    SPECIES_PAL(ALOLAN_GEODUDE, gMonPalette_AlolanGeodude),
    SPECIES_PAL(ALOLAN_GRAVELER, gMonPalette_AlolanGraveler),
    SPECIES_PAL(ALOLAN_GOLEM, gMonPalette_AlolanGolem),
    SPECIES_PAL(ALOLAN_GRIMER, gMonPalette_AlolanGrimer),
    SPECIES_PAL(ALOLAN_MUK, gMonPalette_AlolanMuk),
    SPECIES_PAL(ALOLAN_EXEGGUTOR, gMonPalette_AlolanExeggutor),
    SPECIES_PAL(ALOLAN_MAROWAK, gMonPalette_AlolanMarowak),
