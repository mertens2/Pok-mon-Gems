...
{
    MAP_NUM(SECRET_BASE_RED_CAVE1),    0,  1,  2,
    MAP_NUM(SECRET_BASE_RED_CAVE2),    0,  4, 39,
    MAP_NUM(SECRET_BASE_RED_CAVE3),    0,  1,  3,
    MAP_NUM(SECRET_BASE_RED_CAVE4),    0,  8, 13,
    MAP_NUM(SECRET_BASE_BROWN_CAVE1),  0,  1,  2,
    ...
    MAP_NUM(SECRET_BASE_BLUE_CAVE3),   0, 12, 17,
    MAP_NUM(SECRET_BASE_BLUE_CAVE4),   0,  3, 14,
    MAP_NUM(SECRET_BASE_YELLOW_CAVE1), 0,  38, 2,
    MAP_NUM(SECRET_BASE_YELLOW_CAVE2), 0,  8,  7,
    MAP_NUM(SECRET_BASE_YELLOW_CAVE3), 0,  3,  6,
    MAP_NUM(SECRET_BASE_YELLOW_CAVE4), 0,  5, 11,
    MAP_NUM(SECRET_BASE_TREE1),        0,  2,  3,
    MAP_NUM(SECRET_BASE_TREE2),        0,  4,  2,
    MAP_NUM(SECRET_BASE_TREE3),        0, 24,  3,
    MAP_NUM(SECRET_BASE_TREE4),        0,  4, 13,
    MAP_NUM(SECRET_BASE_SHRUB1),       0,  3,  3,
    MAP_NUM(SECRET_BASE_SHRUB2),       0,  1,  2,
    MAP_NUM(SECRET_BASE_SHRUB3),       0, 12,  8,
    MAP_NUM(SECRET_BASE_SHRUB4),       0, 15,  6,
};
...
void InitSecretBaseDecorationSprites(void)
{
    ...
    for (i = 0; i < numDecorations; i++)
    {
        ...
        if (permission == DECORPERM_SPRITE)
        {
            ...
            {
                gSpecialVar_Result = VAR_OBJ_GFX_ID_0 + (gMapHeader.events->eventObjects[eventObjectId].graphicsId - OBJ_EVENT_GFX_VAR_0);
